...
Version  : 0.3.4
Release  : 15
URL      : https://github.com/uqfoundation/pox/releases/download/0.3.4/pox-0.3.4.tar.gz
Source0  : https://github.com/uqfoundation/pox/releases/download/0.3.4/pox-0.3.4.tar.gz
...
%prep
%setup -q -n pox-0.3.4
cd %{_builddir}/pox-0.3.4
pushd ..
cp -a pox-0.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706544549
