...
Source0  : https://github.com/uqfoundation/pox/releases/download/pox-0.3.2/pox-0.3.2.tar.gz
...
%prep
%setup -q -n pox-0.3.2
cd %{_builddir}/pox-0.3.2
pushd ..
cp -a pox-0.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666629671
...
cp %{_builddir}/pox-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pox/89215dbe96039235796b31ac8e2aa8f659d5c12b || :
